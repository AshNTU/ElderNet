...
angular.module('EldernetToDo.data', [])
...
.factory('Groups', ['FDBRoot', 'Users', function(FDBRoot, Users) {
	...
	retObj.allg = function(){

		return groupsRef.once("value")
		.then(function(allGroupsSnapshot) {
			var groupPromises = [];

			allGroupsSnapshot.forEach(function (groupSnapshot) {
				var groupData = {};
				groupPromises.push(
					retObj.Group(groupSnapshot.key()).once("value")
					.then(function (groupSnap) {
						groupData = groupSnap.val();
						return groupData;
					}));
