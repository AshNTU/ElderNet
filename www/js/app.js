...
angular.module('EldernetToDo', ['ionic', 'EldernetToDo.controllers', 'EldernetToDo.data', 'auth', 'user', 'ionic-material', 'ionMdInput'])

// change this URL to your Firebase
.constant('FBURL', 'https://portale.firebaseio.com/')
